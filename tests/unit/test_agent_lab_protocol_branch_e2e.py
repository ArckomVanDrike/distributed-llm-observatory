...
def test_protocol_runner_evaluates_runtime_branch_decision(
    tmp_path,
    follow_runtime_branch,
    expected_pass,
    expected_criteria,
    ...
    task_payload = {
        "schema_version": "0.1",
        "task_id": "agent-protocol-branch-001",
        ...
        "success_criteria": [
            ...
            },
            {
                ...
                "description": (
                    "The expected runtime branch source "
                    "value was observed."
                ),
            },
            {
                ...
                "description": (
                    "The expected runtime-dependent branch "
                    "was selected."
                ),
            },
        ],
    ...
    class Handler(BaseHTTPRequestHandler):
        ...
        def do_POST(self):
            ...
            state = check_payload["result"]["state"]

            assert state == "missing"

            if follow_runtime_branch:
                next_tool = tools["create_item"]
                next_arguments = {
                    "name": "delta",
                    "count": 4,
                }
            else:
                next_tool = tools["inspect_item"]
                next_arguments = {
                    "name": "delta",
                }
